...
// checks if the EditCollectionsV2Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditCollectionsV2Request{}

// EditCollectionsV2Request struct for EditCollectionsV2Request
type EditCollectionsV2Request struct {
...
func (o EditCollectionsV2Request) MarshalJSON() ([]byte, error) {
...
func (o EditCollectionsV2Request) ToMap() (map[string]interface{}, error) {
...
type NullableEditCollectionsV2Request struct {
	value *EditCollectionsV2Request
	isSet bool
}

func (v NullableEditCollectionsV2Request) Get() *EditCollectionsV2Request {
	return v.value
}

func (v *NullableEditCollectionsV2Request) Set(val *EditCollectionsV2Request) {
	v.value = val
	v.isSet = true
}

func (v NullableEditCollectionsV2Request) IsSet() bool {
	return v.isSet
}

func (v *NullableEditCollectionsV2Request) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditCollectionsV2Request(val *EditCollectionsV2Request) *NullableEditCollectionsV2Request {
	return &NullableEditCollectionsV2Request{value: val, isSet: true}
}

func (v NullableEditCollectionsV2Request) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditCollectionsV2Request) UnmarshalJSON(src []byte) error {
	v.isSet = true
