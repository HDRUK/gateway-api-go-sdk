...
// checks if the FetchAllKeywords200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchAllKeywords200Response{}

// FetchAllKeywords200Response struct for FetchAllKeywords200Response
type FetchAllKeywords200Response struct {
...
func NewFetchAllKeywords200Response() *FetchAllKeywords200Response {
	this := FetchAllKeywords200Response{}
	return &this
}
...
func (o FetchAllKeywords200Response) MarshalJSON() ([]byte, error) {
...
func (o FetchAllKeywords200Response) ToMap() (map[string]interface{}, error) {
...
type NullableFetchAllKeywords200Response struct {
	value *FetchAllKeywords200Response
	isSet bool
}

func (v NullableFetchAllKeywords200Response) Get() *FetchAllKeywords200Response {
	return v.value
}

func (v *NullableFetchAllKeywords200Response) Set(val *FetchAllKeywords200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchAllKeywords200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchAllKeywords200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchAllKeywords200Response(val *FetchAllKeywords200Response) *NullableFetchAllKeywords200Response {
	return &NullableFetchAllKeywords200Response{value: val, isSet: true}
}

func (v NullableFetchAllKeywords200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchAllKeywords200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
