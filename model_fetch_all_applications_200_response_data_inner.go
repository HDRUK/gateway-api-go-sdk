...
// checks if the FetchAllApplications200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchAllApplications200ResponseDataInner{}

// FetchAllApplications200ResponseDataInner struct for FetchAllApplications200ResponseDataInner
type FetchAllApplications200ResponseDataInner struct {
...
func NewFetchAllApplications200ResponseDataInner() *FetchAllApplications200ResponseDataInner {
	this := FetchAllApplications200ResponseDataInner{}
	return &this
}
...
func (o FetchAllApplications200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o FetchAllApplications200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableFetchAllApplications200ResponseDataInner struct {
	value *FetchAllApplications200ResponseDataInner
	isSet bool
}

func (v NullableFetchAllApplications200ResponseDataInner) Get() *FetchAllApplications200ResponseDataInner {
	return v.value
}

func (v *NullableFetchAllApplications200ResponseDataInner) Set(val *FetchAllApplications200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchAllApplications200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchAllApplications200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchAllApplications200ResponseDataInner(val *FetchAllApplications200ResponseDataInner) *NullableFetchAllApplications200ResponseDataInner {
	return &NullableFetchAllApplications200ResponseDataInner{value: val, isSet: true}
}

func (v NullableFetchAllApplications200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchAllApplications200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
