...
> CreateCategories200Response CreateTeamDarApplicationQuestionReview(ctx, teamId, id, questionId).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
...
func main() {
	...
	// response from `CreateTeamDarApplicationQuestionReview`: CreateCategories200Response
...
> CreateCategories200Response CreateTeamDarApplicationReview(ctx, teamId, id).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
...
func main() {
	...
	// response from `CreateTeamDarApplicationReview`: CreateCategories200Response
...
> DeleteAliases200Response DeleteTeamDarApplicationQuestionReview(ctx, teamId, id, questionId, reviewId).Execute()
...
func main() {
	...
	// response from `DeleteTeamDarApplicationQuestionReview`: DeleteAliases200Response
...
> DeleteAliases200Response DeleteTeamDarApplicationReview(ctx, teamId, id, reviewId).Execute()
...
func main() {
	...
	// response from `DeleteTeamDarApplicationReview`: DeleteAliases200Response
...
> DeleteAliases200Response DeleteTeamDarApplicationReviewFile(ctx, teamId, id, reviewId, fileId).Execute()
...
func main() {
	...
	// response from `DeleteTeamDarApplicationReviewFile`: DeleteAliases200Response
...
> FetchUserDarApplicationReviewFile(ctx, userId, id, reviewId, fileId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.DataAccessApplicationReviewAPI.FetchUserDarApplicationReviewFile(context.Background(), userId, id, reviewId, fileId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DataAccessApplicationReviewAPI.FetchUserDarApplicationReviewFile``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiFetchUserDarApplicationReviewFileRequest struct via the builder pattern
...
> FetchTeamDarApplicationReviews200Response FetchUserDarApplicationReviews(ctx, userId, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DataAccessApplicationReviewAPI.FetchUserDarApplicationReviews(context.Background(), userId, id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DataAccessApplicationReviewAPI.FetchUserDarApplicationReviews``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `FetchUserDarApplicationReviews`: FetchTeamDarApplicationReviews200Response
	fmt.Fprintf(os.Stdout, "Response from `DataAccessApplicationReviewAPI.FetchUserDarApplicationReviews`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFetchUserDarApplicationReviewsRequest struct via the builder pattern
...
> UpdateTeamDarApplicationQuestionReview200Response UpdateUserDarApplicationQuestionReview(ctx, userId, id, questionId, reviewId).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DataAccessApplicationReviewAPI.UpdateUserDarApplicationQuestionReview(context.Background(), userId, id, questionId, reviewId).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DataAccessApplicationReviewAPI.UpdateUserDarApplicationQuestionReview``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateUserDarApplicationQuestionReview`: UpdateTeamDarApplicationQuestionReview200Response
	fmt.Fprintf(os.Stdout, "Response from `DataAccessApplicationReviewAPI.UpdateUserDarApplicationQuestionReview`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateUserDarApplicationQuestionReviewRequest struct via the builder pattern
...
> UpdateTeamDarApplicationQuestionReview200Response UpdateUserDarApplicationReview(ctx, userId, id, reviewId).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DataAccessApplicationReviewAPI.UpdateUserDarApplicationReview(context.Background(), userId, id, reviewId).CreateTeamDarApplicationReviewRequest(createTeamDarApplicationReviewRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DataAccessApplicationReviewAPI.UpdateUserDarApplicationReview``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateUserDarApplicationReview`: UpdateTeamDarApplicationQuestionReview200Response
	fmt.Fprintf(os.Stdout, "Response from `DataAccessApplicationReviewAPI.UpdateUserDarApplicationReview`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateUserDarApplicationReviewRequest struct via the builder pattern
