...
// APIClient manages communication with the HDRUK Gateway API API v2.0.0
...
type APIClient struct {
	...
	CustomerSatisfactionAPI *CustomerSatisfactionAPIService

	DarIntegrationAPI *DarIntegrationAPIService

	DataAccessApplicationAPI *DataAccessApplicationAPIService

	DataAccessApplicationReviewAPI *DataAccessApplicationReviewAPIService

	DataAccessSectionAPI *DataAccessSectionAPIService

	DataAccessTemplateAPI *DataAccessTemplateAPIService

	DataAccessTemplatesAPI *DataAccessTemplatesAPIService

	DataCustodianNetworksAPI *DataCustodianNetworksAPIService

	DataProviderCollAPI *DataProviderCollAPIService
	...
	SearchDataCustodiansAPI *SearchDataCustodiansAPIService

	SearchDataUsesAPI *SearchDataUsesAPIService

	SearchDatasetsAPI *SearchDatasetsAPIService

	SearchPublicationsAPI *SearchPublicationsAPIService

	SearchSimilarDatasetsAPI *SearchSimilarDatasetsAPIService
	...
	TeamFederationsAPI *TeamFederationsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DataAccessApplicationAPI = (*DataAccessApplicationAPIService)(&c.common)
	c.DataAccessApplicationReviewAPI = (*DataAccessApplicationReviewAPIService)(&c.common)
	c.DataAccessSectionAPI = (*DataAccessSectionAPIService)(&c.common)
	c.DataAccessTemplateAPI = (*DataAccessTemplateAPIService)(&c.common)
	c.DataAccessTemplatesAPI = (*DataAccessTemplatesAPIService)(&c.common)
	...
	c.SearchDataUsesAPI = (*SearchDataUsesAPIService)(&c.common)
	c.SearchDatasetsAPI = (*SearchDatasetsAPIService)(&c.common)
