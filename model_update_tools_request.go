...
// checks if the UpdateToolsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateToolsRequest{}

// UpdateToolsRequest struct for UpdateToolsRequest
...
func (o UpdateToolsRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateToolsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateToolsRequest struct {
	value *UpdateToolsRequest
	isSet bool
}

func (v NullableUpdateToolsRequest) Get() *UpdateToolsRequest {
	return v.value
}

func (v *NullableUpdateToolsRequest) Set(val *UpdateToolsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateToolsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateToolsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateToolsRequest(val *UpdateToolsRequest) *NullableUpdateToolsRequest {
	return &NullableUpdateToolsRequest{value: val, isSet: true}
}

func (v NullableUpdateToolsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateToolsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
