...
// checks if the FetchDurByIdIntegrations200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchDurByIdIntegrations200ResponseDataInner{}

// FetchDurByIdIntegrations200ResponseDataInner struct for FetchDurByIdIntegrations200ResponseDataInner
type FetchDurByIdIntegrations200ResponseDataInner struct {
	...
	Applicantions *string `json:"applicantions,omitempty"`
...
func NewFetchDurByIdIntegrations200ResponseDataInner() *FetchDurByIdIntegrations200ResponseDataInner {
	this := FetchDurByIdIntegrations200ResponseDataInner{}
	return &this
}
...
// GetApplicantions returns the Applicantions field value if set, zero value otherwise.
func (o *FetchDurByIdIntegrations200ResponseDataInner) GetApplicantions() string {
	if o == nil || IsNil(o.Applicantions) {
		var ret string
		return ret
	}
	return *o.Applicantions
}

// GetApplicantionsOk returns a tuple with the Applicantions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FetchDurByIdIntegrations200ResponseDataInner) GetApplicantionsOk() (*string, bool) {
	if o == nil || IsNil(o.Applicantions) {
		return nil, false
	}
	return o.Applicantions, true
}
...
// SetApplicantions gets a reference to the given string and assigns it to the Applicantions field.
...
func (o FetchDurByIdIntegrations200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o FetchDurByIdIntegrations200ResponseDataInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Applicantions) {
		toSerialize["applicantions"] = o.Applicantions
	}
	if !IsNil(o.Status) {
...
type NullableFetchDurByIdIntegrations200ResponseDataInner struct {
	value *FetchDurByIdIntegrations200ResponseDataInner
	isSet bool
}

func (v NullableFetchDurByIdIntegrations200ResponseDataInner) Get() *FetchDurByIdIntegrations200ResponseDataInner {
	return v.value
}

func (v *NullableFetchDurByIdIntegrations200ResponseDataInner) Set(val *FetchDurByIdIntegrations200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchDurByIdIntegrations200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchDurByIdIntegrations200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchDurByIdIntegrations200ResponseDataInner(val *FetchDurByIdIntegrations200ResponseDataInner) *NullableFetchDurByIdIntegrations200ResponseDataInner {
	return &NullableFetchDurByIdIntegrations200ResponseDataInner{value: val, isSet: true}
}

func (v NullableFetchDurByIdIntegrations200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchDurByIdIntegrations200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
