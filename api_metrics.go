...
func (r ApiFetchKeyMetricsV2Request) Execute() (*FetchKeyMetricsV2200Response, *http.Response, error) {
...
func (a *MetricsAPIService) FetchKeyMetricsV2Execute(r ApiFetchKeyMetricsV2Request) (*FetchKeyMetricsV2200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FetchKeyMetricsV2200Response
	)
