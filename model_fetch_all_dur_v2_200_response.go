...
// checks if the FetchAllDurV2200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchAllDurV2200Response{}

// FetchAllDurV2200Response struct for FetchAllDurV2200Response
type FetchAllDurV2200Response struct {
...
func (o FetchAllDurV2200Response) MarshalJSON() ([]byte, error) {
...
func (o FetchAllDurV2200Response) ToMap() (map[string]interface{}, error) {
...
type NullableFetchAllDurV2200Response struct {
	value *FetchAllDurV2200Response
	isSet bool
}

func (v NullableFetchAllDurV2200Response) Get() *FetchAllDurV2200Response {
	return v.value
}

func (v *NullableFetchAllDurV2200Response) Set(val *FetchAllDurV2200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchAllDurV2200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchAllDurV2200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchAllDurV2200Response(val *FetchAllDurV2200Response) *NullableFetchAllDurV2200Response {
	return &NullableFetchAllDurV2200Response{value: val, isSet: true}
}

func (v NullableFetchAllDurV2200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchAllDurV2200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
