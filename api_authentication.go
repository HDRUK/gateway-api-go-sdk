...
func (r ApiRefreshTokenRequest) Execute() (*Authentication200Response, *http.Response, error) {
...
// Execute executes the request
//  @return Authentication200Response
func (a *AuthenticationAPIService) RefreshTokenExecute(r ApiRefreshTokenRequest) (*Authentication200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/v1/refresh_token"
